...
const DishTable: React.FC = () => {
  ...
  const [selectedDish, setSelectedDish] = useState<any>(null); // eslint-disable-line @typescript-eslint/no-explicit-any
  ...
  const handleDishClick = (dish: any) => { // eslint-disable-line @typescript-eslint/no-explicit-any
